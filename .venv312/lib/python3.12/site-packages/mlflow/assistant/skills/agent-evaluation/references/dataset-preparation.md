...
```python
{"inputs": {"query": "your question here"}}  # DONE CORRECT - matches parameter name
```
...
1. DONE Read MLflow GenAI dataset documentation (see top of file)
2. DONE Examine your agent's function signature
3. DONE Know exact parameter names to use in `inputs` dict
